...
int main(int argc, char **argv)
{
 ...
 pSubVector1  = (int *) GetMem(pSizeSubV[MyRank],sizeof(int),"SubVector1");
 pSubVector2  = (int *) GetMem(pSizeSubV[MyRank],sizeof(int),"SubVector2");
 ...
 if (MyRank!=Root)
    {
     ...
     MPI_Reduce(&LocalMedia, &media, 1, MPI_INT, MPI_SUM, Root, MPI_COMM_WORLD);
    }
 ...
 if (MyRank==Root)
    {
     ...
     MPI_Reduce(MPI_IN_PLACE, &media, 1, MPI_INT, MPI_SUM, Root, MPI_COMM_WORLD);
    }
