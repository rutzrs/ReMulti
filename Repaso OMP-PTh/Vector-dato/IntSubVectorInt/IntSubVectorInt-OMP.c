...
/*---------------------------------------------------------------------------*/
//Subs x to Vector
void IntSubVectorInt(int *pVector, const int Rows, const int dato)
{
#ifdef OPENMP
#pragma omp parallel for default(none) shared(pVector,Rows,dato)
#endif
 for (int i=0;i<Rows;i++)
...
int main(int argc, char **argv)
{
 ...
 IntSubVectorInt(pVector,Rows,x);
